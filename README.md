...
This is the second model in my finance portfolio, following a Geometric Brownian Motion (GBM) simulation.
...
* **Long-Run Evolution:** Tracks the specific probability vector of a borrower across 787 years until the probability of default reaches ~99.99%.
